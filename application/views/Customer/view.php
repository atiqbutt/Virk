              ...
              <div class="row">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                   ...
                   <a type="submit" name="register" href='<?php echo base_url()?>Defination/customerpage'; class="btn btn-danger"><i class="fa fa-reply"></i></a>
                 <a class="btn btn-primary" float:right href="<?php echo $base_url; ?>Defination/printcustomer/<?php echo $view->id; ?>" target="_blank"><i class="fa fa-print"></i></a>
