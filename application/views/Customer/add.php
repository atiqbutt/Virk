      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box col-sm-12">
            ...
            <div class="box-body">
             <div class="col-md-9">
                <form class="form-horizontal" id="shippingForm" action="<?php echo base_url()?>Defination/savecustomer" method="post" enctype="multipart/form-data"> 
                    ...
                    <div class="item form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <a type="submit" name="register" href='<?php echo base_url()?>Defination/customerpage' class="btn btn-danger">Cancel</a>
