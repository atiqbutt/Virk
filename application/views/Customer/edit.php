        ...
        <div class="col-xs-12">
          <div class="box col-sm-12">
            <div class="box-header" >
              <h3 class="box-title">Manage Customer Information</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <div class="col-md-9">
                <form class="form-horizontal" id="defaultForm" action="<?php echo base_url()?>Defination/updatecustomer" method="post" enctype="multipart/form-data"> 
