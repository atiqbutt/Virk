      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box col-sm-12">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                 <form class="form-horizontal"  action="<?php echo base_url()?>Maintenance/save_token" method="post">         
                     ...
                     <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  name="token" type="text" class="form-control" onkeypress='return ValidateNumberOnly()'>                        
                          </div>
                      </div>
