      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box col-sm-12">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                 <form id="token" class="form-horizontal"  action="<?php echo base_url()?>Maintenance/save_token" method="post">
                     ...
                     <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="time">Token Number<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="item form-group">
                     ...
                     <div class="item form-group">
                      ...
                      <a class="btn btn-danger" href="<?php echo base_url() ?>maintenance/view_token">Cancel</a>
                      </div>  
